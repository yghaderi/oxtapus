...
is_insurance = {
    "درآمد حق بیمه ناخالص", "premium_earned",
    "حق بیمه اتکایی واگذاری", "expense_of_reinsurance_transfer_premium",
    "حق بیمه خالص (سهم نگهداری)", "premium_earned_retention",
    "درآمد سرمایه گذاری از محل منابع بیمه ای", "investment_income_from_technical_reserves",
    "سایر درآمدهای بیمه ای", "other_insurance_income",
    "درآمدهای بیمه ای", "insurance_income",
    "خسارت و مزایای پرداختی (ناخالص)", "cost_of_claims",
    "خسارت سهم بیمه گران اتکایی", "cost_of_claims_reinsurers_hare",
    "خسارت و مزایای پرداختی خالص", "cost_of_Claims_Retention",
    "هزینه سهم مشارکت در منافع", "cost_of_interest_participating",
    "تغییرات سایر ذخایر فنی", "other_technical_reserves_changes",
    "سایر هزینه های بیمه ای", "other_insurance_costs",
    "هزینه های بیمه ای", "insurance_costs",
    "سود (زیان) ناخالص فعالیتهای بیمه ای", "gross_profit_of_insurance_activities",
    "هزینه های اداری و عمومی", "sales_general_and_administrative_expense",
    ...
    "سایر درآمدها و هزینه های غیر عملیاتی", "net_other_non_operating_gains_and_expenses",
    "سود (زیان) قبل از مالیات", "earning_before_tax",
    "مالیات بر درآمد", "tax",
    "سود (زیان) خالص", "net_income",
    "سود (زیان) خالص هر سهم– ریال", "eps",
    "سرمایه", "listed_capital",
